    ...
    struct MotionNode {
        ...
        struct ClipSlot {
            ...
            std::array<std::uint32_t, 4> packedColors{ 0xFF808080u, 0xFF808080u,
                                                       0xFF808080u,
                                                       0xFF808080u };
            // content.mesh.bp (4x4 unit-space Bezier control grid).  This is
            // part of the frame payload and must survive the two-slot
            // crossfade cache just like transform/color fields.
